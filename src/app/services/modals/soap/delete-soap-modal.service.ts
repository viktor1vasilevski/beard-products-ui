...
import { DeleteSoapModalComponent } from 'src/app/components/modals/soap/delete-soap-modal/delete-soap-modal.component';

@Injectable({
  providedIn: 'root'
})
export class DeleteSoapModalService {

  private componentRef!: ComponentRef<DeleteSoapModalComponent>;
  ...
  openModal(entry: ViewContainerRef, modalTitle: string, modalSubTitle: string, quantity: any, price: any, imageUrl: string) {
    let factory = this.resolver.resolveComponentFactory(DeleteSoapModalComponent);
